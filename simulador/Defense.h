...
namespace Asedio
{
    ...
    public:
        ...
        //Return double for calculate the time. 
        double  placeDefenses_(STRATEGY_MODE mode, int nCellsBorderWidth = 1, int nCellsBorderHeight = 1, bool silentlibs = false, float minExecutionTime = 0);
        void placeDefensesRandomly();
        
        void selectDefenses_(unsigned int ases, bool silentlibs = false);
